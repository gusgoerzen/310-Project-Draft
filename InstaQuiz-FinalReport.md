...
2.
|---------------------------------------------------------------------------------------|---------------------------------------|
|                             **Initial Requirements**                                  |  **Complete / Incomplete / Modified** |
|---------------------------------------------------------------------------------------|---------------------------------------|
|*User Requirements:*                                                                                                           |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 1. Users can create an InstaQuiz account with instructor, or student privileges using |              Complete                 |
|    their email address and a custom password.                                         |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 2. Users can login to their InstaQuiz accounts using their email address and password.|              Complete                 |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 3. Users can logout by clicking a constantly displayed button in the top right of the |              Complete                 |
|    web-page.                                                                          |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 4. Instructors can create a new course module, this automatically enrolls them in the |              Complete                 |
|    course, as the instructor.                                                         |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 5. Instructors can delete any course module they have personally created.             |              Complete                 |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 6. Users can search for a course module by title or instructor.                       |              Complete                 |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 7. Users can enroll in any course module that they are not currently enrolled in.     |              Complete                 |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 8. Instructors and students can unenroll from a course they are currently enrolled in.|              Complete                 |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 9. Instructors can start a live course session in any courses they have created.      |              Complete                 |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 10. If an instructor has any ongoing live sessions, they can end them whenever, as    |              Complete                 |
|     long as no polling windows are active.                                            |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 11. Users can join a live course session, provided that the instructor has started it |              Complete                 |
|     already.                                                                          |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 12. Instructors can create a storage bank of custom questions with corresponding      |              Complete                 |
|     multiple choice answer sets.                                                      |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 13. Instructors can start a polling window during a live session as long as no other  |              Modified                 |
|     polls are already in progress.                                                    |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 14. Instructors can end their live polling window and declare the correct answer to   |              Modified                 |
|     the question.                                                                     |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 15. Users can answer a question by clicking on the corresponding answer listed beneath|              Complete                 |
|     the question text. A user can change their answer during the polling window.      |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 16. Instructors can choose to display a summary of the question, (correct answer, how |                                       |
|     many votes each answer got, how many total responses, etc.) or to keep it hidden  |              Incomplete               |
|     from the class. Instructors will be able to see this summary regardless after they|                                       |
|     end a polling window.                                                             |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 17. For each course they are enrolled in, students will be able to see their current  |                                       |
|     score, attendance record, and response history throughout previously attended live|              Incomplete               |
|     sessions.                                                                         |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 18. For each course they have created, instructors will have access to their students |              Incomplete               |
|     grades, attendance records, and response history.                                 |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| *Interface Requirements:*                                                                                                     |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 1. Students have an overview page which displays each course they are enrolled in, and|              Complete                 |
|    gives them the option to join a class, or unenroll from one.                       |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 2. Students can access course pages from the overview page where they will be able    |              Incomplete               |
|    to view their course statistics and join live sessions that are currently running. |                                       |
|---------------------------------------------------------------------------------------|---------------------------------------|
| 3. During a polling window, the question statistics are displayed and updated in real 
|    time. (How many students have answered/ not answered) | I |
|---------------------------------------------------------------------------------------|---------------------------------------|
| **Functional:** |
|---------------------------------------------------------------------------------------|---------------------------------------|
...
### 4.
Many components were reused accross both student and instructor accounts as they have similar requirements. Database connections, authentication processes, and form validation functions.  

<br>

### 5.
How many tasks are left in the backlog?
There are **N** tasks left in the backlog
...
Initially, our team started with a TDD model by writing a large variety of tests in JUnit. However, during the implementation phase, and after careful consideration of the requirements, we ended up switching from Java to PHP. We setup PHPUnit ....    
<br>
